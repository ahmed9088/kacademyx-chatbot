      ...
      >
        <div className="bg-dark-800/80 backdrop-blur-xl border border-dark-700/50 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="flex flex-col items-center gap-3 mb-8">
            <div className="w-14 h-14 flex items-center justify-center bg-gradient-to-br from-primary-500 to-secondary-500 rounded-2xl text-white shadow-glow">
              <Sparkles size={28} />
            </div>
            <div className="text-center">
              <h1 className="text-2xl font-bold text-dark-100">Welcome to Kacademyx</h1>
              <p className="text-sm text-dark-400 mt-1">Your AI-powered learning companion</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            {error && (
              <p className="text-red-400 text-sm text-center bg-red-500/10 py-2 px-3 rounded-lg">
                {error}
              </p>
            )}
